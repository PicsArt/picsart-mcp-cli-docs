---
description: "The full Picsart AI model catalog — 150+ models from 30+ providers across image, video, audio, and text analysis, usable from the gen-ai CLI and MCP."
---

# Model Reference

The full Picsart AI Playground catalog: **150+ models** from **30+ providers**, across image, video, audio, and text. Every model is usable from both the [gen-ai CLI](/guide/cli-quickstart) and the [MCP server](/guide/mcp-quickstart) with the same id.
...
| Mode | Models | Browse |
|---|---|---|
| Image | 70+ | [Image generation](/reference/image) |
| Video | 70+ | [Video generation](/reference/video) |
| Audio | 20+ | [Audio generation](/reference/audio) |
