...
The `gen-ai-use` skill gives Claude Code access to all **176 models** across image, video, and audio. Browse them at [picsart.com/ai-playground](https://picsart.com/ai-playground/) or run:
