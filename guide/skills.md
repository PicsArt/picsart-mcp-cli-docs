...
The flagship skill, **`gen-ai-use`**, gives an agent access to all **181 models** across image, video, and audio generation. It works with Claude Code, Cursor, and Windsurf.
