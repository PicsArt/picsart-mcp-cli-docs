...
description: "Build videos, slideshows and captioned clips from your own footage and ready-made templates, by asking Claude — Picsart Media Studio assembles the piece and renders it for you."
---

# Picsart Media Studio

**Picsart Media Studio** lets you build videos and images by asking Claude for them in plain
language. You supply the material — your own clips and photos, some text, a template you like — and
Claude assembles it and renders the finished file.

Everything it makes is built from what you give it and the templates, effects and fonts it offers.
If you want Claude to create an image or a video from a written description instead, that is the
...
Claude works the way a person would in an editing app, one step at a time:
...
2. **It builds the piece.** Claude stacks up the parts — a background clip, some text, a logo — and
...
- **Nothing is saved as you work.** Claude keeps the piece in the conversation until it renders,
  so it helps to stay in one thread while building something.

## What you need

- A **Picsart account** — Claude signs you in when you connect.
...
the address above. Claude opens a browser window for you to sign in to Picsart, and the tools show
...
Claude will look through the templates, fill one in, show you a thumbnail to check, and render the
finished picture.
...
Claude opens the drop area, transcribes the speech once you have added the file, lays the captions
over the video, and renders it.
...
Ask Claude *"what can Picsart Media Studio do?"* or *"how would you join two videos with Media
...
Media Studio works with Claude and is built on the open
