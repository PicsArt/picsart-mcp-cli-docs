---
description: "The Picsart REST API — HTTP access to 178 models from any language. Full documentation at picsart.com/api-platform/docs/api-reference."
---

# REST API

The Picsart REST API exposes the same 178 models as the CLI and MCP server over plain HTTP. Use it from Python, Ruby, Go, or any language that can make an HTTP request.
