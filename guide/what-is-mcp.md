...
The Picsart MCP server (`gen-ai-mcp`) exposes the full AI Playground model catalog — **178 models** from **31 providers** — as MCP tools. Once connected, your agent can:
