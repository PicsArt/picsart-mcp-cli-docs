...
`@picsart/ai-sdk` gives Node.js and TypeScript applications type-safe access to the same 166 models available in the CLI and MCP server. If you are building a product rather than running scripts or working inside an AI agent, this is the right surface.
...
| Models | Same 166 models as CLI and MCP |
