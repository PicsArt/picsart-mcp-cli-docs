...
`@picsart/ai-sdk` gives Node.js and TypeScript applications type-safe access to the same 178 models available in the CLI and MCP server. If you are building a product rather than running scripts or working inside an AI agent, this is the right surface.
...
| Models | Same 178 models as CLI and MCP |
